                            ...
                            <div className="popup-notification relative">
                                ...
                                <div className="popup-user relative">
                                    <div className="user" onClick={handleToggle}>
                                        ...
                                        <span>Jordan Bowes<i className="icon-keyboard_arrow_down" /></span>
                                    </div>
                            ...
                            <div className="over-content">
                                <div className="content">
                                    ...
                                    <ul className="menu-tab">
                                        ...
                                        <li className={activeIndex === 7 ? "tablinks active" : "tablinks"} data-tabs="favorite" onClick={() => handleOnClick(7)}>
                                            <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g opacity="0.2">
