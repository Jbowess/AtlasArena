                                    ...
                                    <div className="tf-soft flex items-center justify-between">
                                        <div className="soft-left">
                                            <Menu as="div" className="dropdown">
                                                <Menu.Button className="btn btn-secondary" type="button" id="dropdownMenuButton" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <Menu as="div" className="dropdown">
                                                <Menu.Button className="btn btn-secondary" type="button" id="dropdownMenuButton2" aria-haspopup="true" aria-expanded="false">
                                                    <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <Menu as="div" className="dropdown">
                                                <Menu.Button className="btn btn-secondary" type="button" id="dropdownMenuButton3" aria-haspopup="true" aria-expanded="false">
                                                    <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="tf-card-box style-1" onClick={openSignUpModal}>
                                        ...
                                        <div className="author flex items-center">
                                            ...
                                            <div className="info">
                                                ...
                                                <h6><Link href="/author-2">Kristin Watson</Link> </h6>
                                            </div>
                                        </div>
