                            ...
                            <div className="row">
                                ...
                                <div data-wow-delay="0.1s" className="wow fadeInUp col-md-4">
                                    <div className="box-icon-item">
                                        ...
                                        <div className="title"><Link href="#">Compete In Skill-Based Games</Link></div>
                                        <p>Progress through each tier by winning skill-based games. The better you play, the greater the rewards</p>
                                    </div>
                                </div>
                                <div data-wow-delay="0.2s" className="wow fadeInUp col-md-4">
                                    <div className="box-icon-item">
                                        ...
                                        <p>Outshine Atlas, grab exclusive rewards! Open your loot box, triumph over us, and prove you're the best. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
